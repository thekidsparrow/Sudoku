let puzzle = [[ 8,9,5,   7,4,2,   1,3,6 ],  // 0
 ...
 let isValid = sudokuIsValid(puzzle);
 ...
 let sudokuIsSame = isSame(puzzle, puzzle2);
 ...
 function sudokuChecker(puzzle)
 {
      ...
      let row = getRow(puzzle, 2);
      let section = getSection(puzzle, 1, 0);
      let isValidSection = includes1to9(section);
 }
